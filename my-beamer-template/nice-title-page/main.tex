...
\include{py-talk}  % THIS is the line that includes the FU template!
...
\title[我可以说中文我可以说中文我可以说中文我可以] % (optional, use only with long paper titles)
{我可以说中文}

\subtitle
{如果有副标题的话}

\author[宣读作者] % (optional, use only with lots of authors)
{第一作者 \and 第二作者}
% - Give the names in the same order as the appear in the paper.

\institute[商学院] % (optional, but mostly needed)
{宁波大学商学院}
% - Keep it simple, no one is interested in your street address.

\date[2013年学术大会] % (optional, should be abbreviation of conference name)
{\today}
...
\renewcommand{\footlinetext}{\insertshortauthor - \insertshorttitle}
